...
export default function ProductCard({ product }) {
  ...
  return (
    <Link href={`/product/${id}`} className="bg-surface-container-lowest border border-outline-variant p-2 sm:p-3 rounded shadow-sm group transition-all hover:shadow-md flex flex-col h-full relative">
      ...
      <div className={`relative aspect-[3/4] mb-2 sm:mb-3 overflow-hidden rounded bg-surface-container ${!in_stock ? 'opacity-50 grayscale-[50%]' : ''}`}>
